...
@section('title') 
Chi tiết: {{ $service->name }} - GreenEmpire 
@endsection 
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="price-box mb-4 p-3 bg-light rounded border-start border-success border-4">
                <span class="text-muted text-decoration-line-through">Giá tham khảo: {{ number_format($service->base_price * 1.1) }} VNĐ</span>
                <h3 class="text-danger fw-bold">
                    {{ number_format($service->base_price) }} VNĐ <small class="text-muted">/ {{ $service->unit }}</small>
                </h3>
            </div>
